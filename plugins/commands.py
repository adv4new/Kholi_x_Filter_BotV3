...
async def start(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "ᴊᴏɪɴ ᴍʏ ᴄʜᴀɴɴᴇʟ ᴛᴏ ɢᴇᴛ ғɪʟᴇs", url=invite_link.invite_link
                )
            ]
        ]
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            InlineKeyboardButton('🍁 𝗢𝗪𝗡𝗘𝗥 🍁', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('🔍𝗦𝗘𝗔𝗥𝗖𝗛 𝗛𝗘𝗥𝗘', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🍂 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 🍂', url='https://t.me/Mh_linkZzz')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('ᴊᴏɪɴ ᴜs', url='https://t.me/Mh_linkZzz') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
