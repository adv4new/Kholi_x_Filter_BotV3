...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton(f"{stat}", callback_data=f"{cb}:{group_id}"),
             InlineKeyboardButton("𝗗𝗘𝗟𝗘𝗧𝗘", callback_data=f"deletecb:{group_id}")],
            [InlineKeyboardButton("𝗕𝗔𝗖𝗞", callback_data="backcb")]
        ])
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🍁 𝗢𝗪𝗡𝗘𝗥 🍁', url=f'https://t.me/thilak2003')
        ], [
            InlineKeyboardButton('🔍 𝗦𝗘𝗔𝗥𝗖𝗛 𝗠𝗢𝗩𝗜𝗘𝗦', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🍂 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 🍂', url='https://t.me/Mh_linkZzz')
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🎖️ 𝗔𝗨𝗧𝗢 𝗙𝗜𝗟𝗧𝗘𝗥 🎖️', callback_data='autofilter')
        ], [
            InlineKeyboardButton('🔸𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗜𝗢𝗡🔸', callback_data='coct'),
            InlineKeyboardButton(' 📢 𝗙𝗘𝗔𝗧𝗨𝗥𝗘𝗦 📢 ', callback_data='extra')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('🍁 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 🍁', url='https://t.me/Mh_linkZzz'),
            InlineKeyboardButton('📜 𝗚𝗥𝗢𝗨𝗣 📜',url='https://t.me/moviereqgroup_movieshub')
        ], [
            InlineKeyboardButton('🏡 𝗛𝗢𝗠𝗘', callback_data='start'),
            InlineKeyboardButton('🗑️ 𝗖𝗟𝗢𝗦𝗘', callback_data='close_data')
        ]]
        reply1 = await query.message.reply_text(
            text="â–¢â–¢â–¢"
        )
